...
const CompareSection = () => {
  return (
    <section className="py-20 px-4 bg-gradient-to-r from-red-50 via-orange-50 to-yellow-50 dark:from-red-950/10 dark:via-orange-950/10 dark:to-yellow-950/10">
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mb-6"
              data-translate
              data-en="Your Competitors Are Already Moving Ahead"
              data-ar="منافسوك يتقدمون بالفعل">
            Your Competitors Are Already Moving Ahead
          </h2>
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto"
             data-translate
             data-en="While you're stuck with manual processes, smart GCC businesses are already automating and scaling 3x faster. How much longer can you afford to wait?"
             data-ar="بينما أنت عالق في العمليات اليدوية، الشركات الذكية في دول الخليج تقوم بالأتمتة والنمو بسرعة 3 أضعاف. كم من الوقت يمكنك تحمل الانتظار؟">
            ...
            <CardContent className="p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-red-600"
                    data-translate
                    data-en="Generic Software (Your Current Struggle)"
                    data-ar="البرامج العامة (كفاحك الحالي)">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-red-700">English-Only = Team Confusion</p>
                    <p className="text-sm text-red-600">Your Arabic-speaking team struggles daily</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
            ...
            <CardContent className="p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-green-600"
                    data-translate
                    data-en="Nunar AI Agents (Your Growth Accelerator)"
                    data-ar="وكلاء نونار الذكية (محرك نموك)">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-start space-x-3">
                  <Check className="h-5 w-5 text-green-500 mt-1" />
                  <div>
                    <p className="font-semibold text-green-700">Native Arabic = Team Productivity</p>
                    <p className="text-sm text-green-600">Your team works in their preferred language</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="h-5 w-5 text-green-500 mt-1" />
        ...
        <div className="text-center bg-gradient-to-r from-orange-900/10 to-red-900/10 rounded-2xl p-8 border-2 border-orange-200">
          <h3 className="text-3xl font-bold mb-4 text-orange-600"
              data-translate
              data-en="Stop Adapting to Software. Get Software That Adapts to You."
              data-ar="توقف عن التكيف مع البرمجيات. احصل على برمجيات تتكيف معك.">
            Stop Adapting to Software. Get Software That Adapts to You.
          </h3>
          <p className="text-lg text-muted-foreground mb-6"
             data-translate
             data-en="Every day you delay, you're losing money to inefficiency while competitors pull ahead. Only 15 spots available for Q4 2024."
             data-ar="كل يوم تأخر فيه، تخسر المال بسبب عدم الكفاءة بينما المنافسون يتقدمون. 15 مكان فقط متاح للربع الأخير من 2024.">
